...
const Footer = () => {
    return (
        <>
        <div className="px-30 py-10 flex justify-between bg-gray-100">
            ...
            <div className="px-10 bg-gray-100 flex items-center">
                <button className="px-15 py-2 bg-orange-500 hover:bg-gray-100 hover:border border-black">Contact Us</button>
            </div>
